...
const Dashboard = () => {
    ...
    const leftButtons = [
        { label: "Transactions", icon: <GiCash className='w-6 h-6 text-[#0ea5e9]' />, action: "transactions" },
    ...
    const rightButtons = [
        { label: "Orders", icon: <VscListOrdered className='w-6 h-6 text-[#0ea5e9]' />, action: "orders" },
        // { label: "Customers", icon: <FaUsersCog className='w-6 h-6 text-sky-400' />, action: "customers" },
    ]
        ...
        <section className = 'bg-[#1a1a1a] h-[calc(100vh)] overflow-y-scroll scrollbar-hidden'>
            ...
            <div className='flex items-center justify-between px-8 py-3 bg-[#383838] shadow-xl mb-2'>
                    <div className='flex items-center'>
                        <BackButton />
                        <h1 className='text-lg font-semibold text-white ml-2'>Dashboard</h1>
                    </div>

                    <div className='flex items-center justify-end gap-2'>
                    <div className='flex gap-2 justify-end gap-3 hover:bg-[#0ea5e9] shadow-lg/30'>
                        {
                            leftButtons.map(({ label, icon, action }) => {
                                return (
                                    <button onClick={() => handleOpenModal(action)}
                                        className='bg-[#f6b100] px-2 py-1 text-[#1a1a1a] cursor-pointer
