...
const Services = () => {
    ...
    const addBtn = [{ label :'Add item' , action :'service' , icon: <IoIosAddCircle className ='text-sky-600 w-6 h-6'/>}];
        ...
        <section className ='h-[calc(100vh)] overflow-y-scroll scrollbar-hidden bg-[#1a1a1a]'>
            <div className='flex items-center justify-between px-10 py-3 bg-[#383838]'>
                ...
                <div className='flex items-center gap-4'>
                    <BackButton />
                    <h1 className='text-[#f5f5f5] text-lg font-bold tracking-wider'>Items Management</h1>
                </div>
            ...
            <div className='mt-5 bg-[#1f1f1f] py-1 px-10'>
                ...
                <div className='overflow-x-auto bg-[#1f1f1f]'>
                    <table className='text-left w-full'>
                        <thead className=''>
                            <tr className='border-b-2 border-[#f6b100] text-xs font-normal text-sky-400'>
                        ...
                        <tbody>
                            ...
                            {services.length === 0
                                ...
                                : services.map((service) => (
                                    ...
                                    <tr
                                        key={service._id}
                                        className='border-b border-[#383838] text-xs font-normal text-[#e6e6e6] cursor-pointer hover:bg-[#383838]'
                                    >
