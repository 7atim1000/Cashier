...
const  Auth = () => {
    ...
    return (
        ...
        <div className ='flex min-h-screen w-full h-full overflow-y-scroll scrollbar-hidden'>
            ...
            {/*Right end */}
            <div className ='w-1/2 min-h-screen bg-[#1a1a1a] p-3 overflow-y-scroll scrollbar-hidden'>
                ...
                <h2 className ='text- xl text-center mt-2 font-semibold text-[#f6b100] mb-10'>
