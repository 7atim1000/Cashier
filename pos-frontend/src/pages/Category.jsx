...
const Category = () => {
    ...
    return(
        <section className ='h-[calc(100vh)] overflow-y-scroll scrollbar-hidden bg-[#1a1a1a]'>
            ...
            <div className='flex justify-between items-center px-5 py-2 bg-[#383838]'>
                <div className='flex items-center gap-2'>
                    <BackButton />
                    <h1 className='text-lg font-semibold text-[#f5f5f5]'>Categories Management</h1>
                </div>

                <div className='flex gap-2 items-center justify-around gap-3 hover:bg-[#0ea5e9] shadow-lg/30'>
                    {addBtn.map(({ label, icon, action }) => {
                        return (
                            <button className ='bg-[#f6b100] px-4 py-2 text-[#1a1a1a] cursor-pointer
