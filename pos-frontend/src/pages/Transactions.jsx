...
import AddTransaction from '../components/tranactions/AddTransaction';
...
const Transactions = () => {
    ...
    const PaginationControls = () => {
        ...
        return (  //[#0ea5e9]
            <div className="flex justify-between items-center mt-2 py-2 px-5 bg-[#383838] shadow-lg/30 rounded-lg
            text-xs font-medium border-b-3 border-[#0ea5e9] border-t border-[#ea5e9]">
                <div className ='text-[#f5f5f5] text-xs font-normal'>
                    Showing
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        text-xs font-normal disabled:opacity-50 text-[#f5f5f5] text-xs font-normal"
                    >
                        Previous
                    </button>

                    <span className="px-3 py-1 text-[#f5f5f5] text-xs font-normal">
                        Page
                    ...
                    <button
                        ...
                        className="px-2 py-1 shadow-lg/30 border-b border-[#0ea5e9] 
                        text-[#f5f5f5] text-xs font-normal disabled:opacity-50"
                    >
                        Next
                    </button>
                    ...
                    <select
                        ...
                        className="border-b border-[#0ea5e9] px-2 font-normal shadow-lg/30 text-[#f5f5f5] text-xs font-normal"
                    >
    ...
    return(
        <section className ='h-[100vh] overflow-y-scroll scrollbar-hidden flex gap-3 bg-[#1a1a1a]'>
            <div className ='flex-[3] bg-[#1f1f1f] h-[100vh] overflow-y-scroll scrollbar-hidden '>
                
                <div className='flex items-center justify-between px-8 py-3 bg-[#383838] shadow-xl mb-2'>
                    <div className='flex items-center'>
                        <BackButton />
                        <h1 className='text-lg font-semibold text-white ml-2 text-[#f5f5f5]'>Transactions Management</h1>
                    </div>
                ...
                {/* Search and sorting */}
                <div className="flex gap-2 items-center px-15 py-2 shadow-xl bg-[#383838] text-white">
                    <input
                        type="text"
                        placeholder="Search..."
                        className="bg-[#383838] text-white border border-[#0ea5e9] p-1 rounded-lg w-full text-sm font-semibold"
                        // max-w-md
                        value={search}
                    ...
                    <select
                        className="border bg-[#383838] border-[#0ea5e9] p-1  rounded-lg text-white text-sm font-semibold cursor-pointer "
                        value={sort}
                ...
                <div className='mt-5 h-full' >
                    <div className='overflow-x-auto mx-5'>
                        <table className='w-[100%] text-left' >
                            <thead className='bg-[#1a1a1a] border-b-2 border-[#f6b100] text-[#0ea5e9] text-xs font-normal'>
                                <tr> {/**bg-[#D2B48C] */}
                                    <th className='p-1'></th>
                                    <th className='p-1'></th>
                                    <th className='p-1'></th>
                            ...
                            <tbody>
                                ...
                                {list.length === 0
                                    ...
                                    : list.map((transaction, index) => (
                                        ...
                                        <tr
                                             key ={index}
                                            className='border-b border-[#383838] text-xs font-normal text-[#e6e6e6] hover:bg-[#383838] cursor-pointer'
                                        >
                            ...
                            {list.length > 0 && (
                                ...
                                <tfoot className='bg-[#383838] border-t-2 border-[#383838] text-white text-xs font-semibold'>
                                    <tr>
            ...
            <div className ='flex-[1] bg-[#1f1f1f] px-2 py-3'>
                <div className="flex gap-2 items-center px-15 py-2 shadow-xl bg-[#383838] text-white">
                    <select id='frequency' value={frequency} onChange={(e) => setFrequency(e.target.value)}
                        className='border border-[#f6b100] rounded-md px-2 py-1 text-xs text-white bg-[#383838]'>
                ...
                <div className='flex flex-col items-start mt-2 bg-[#383838]'>
                    
                    <p className='text-xs text-[#f6b100] font-semibold ml-2 mb-2 mt-2'>Count of transactions :-</p>
                    <div className='flex items-center justify-between w-full px-5'>

                        <div className='flex  items-center justify-center gap-3'>
                            <span className='text-xs font-normal text-white '>Incomes : </span>
                            <p className='font-semibold text-md text-green-600 p-1'>
                                {totalIncomeTransactions.length} 
                                <span className ='text-white text-xs font-normal'> Process</span>
                            </p>
                        </div>
                        {/* {totalExpenseTransactions.length} */}
                        <div className='flex  items-center justify-center gap-3'>
                            <span className='text-xs font-normal text-white '>Expenses : </span>
                ...
                <div className='flex flex-col items-start mt-2 bg-[#383838]'>
                    ...
                    <p className='text-xs text-[#f6b100] font-semibold ml-2 mb-2 mt-2'>Amounts Totals :-</p>
                    <div className='flex flex-col gap-5 justify-between w-full px-5'>

                        <div className='flex  items-center justify-center gap-3'>
                            <span className='text-xs font-normal text-white '>All : </span>
                            <p className='font-semibold text-md text-[#0ea5e9] p-1'>
                                {totalTurnover.toFixed(2)}
                                <span className='text-white text-xs font-normal'> AED</span>
                            </p>
                        </div>
                ...
                <div className='flex flex-col items-start mt-2 bg-[#383838]'>
                    ...
                    <p className='text-xs text-[#f6b100] font-semibold ml-2 mb-2 mt-2'>Percentage of transactions :-</p>
                    <div className='flex items-center justify-between w-full px-5'>
                ...
                <div className='flex flex-col items-start mt-15'>
                    <p className='text-xs text-[#f6b100] font-semibold ml-2 mb-5 mt-2'>Graphical Explanation :-</p>
                    <div className='flex items-center justify-between w-full px-15'>
                        <div className='flex items-start justify-start bg-[#383838] p-1 rounded-lg '>
                            <Progress type='circle' strokeColor={'green'} size={90} percent={totalIncomeTurnoverPercent.toFixed(0)} />
                        </div>
                        <div className='flex items-end justify-end bg-[#383838] rounded-lg  p-1'>
