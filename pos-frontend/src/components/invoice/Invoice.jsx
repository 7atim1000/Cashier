        ...
        <div className ='fixed inset-0 bg-opacity-50 flex justify-center items-center'>
            <div className = 'bg-white p-4 rounded-lg shadow-lg  w-[400px]'>
                ...
                <div className ='flex justify-between mt-4'>
                    <button
                        onClick={handlePrint}
                        className ='text-blue-500 hover underline text-xs px-4 py-2 rounded-lg cursor-pointer'
                    >  
                        Print Receipt
                    </button>
                    <button
                        onClick={() => setShowInvoice(false)}
                        className ='text-red-500 hover: underline text-xs px-4 py-2 rounded-lg cursor-pointer'
                    >
                        Close
                    </button>
