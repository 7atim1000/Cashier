        ...
        <div className =''>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className ='flex items-center justify-between'>
                    <label htmlFor='' className ='w-[10%] block text-[#0ea5e9] mb-2 text-xs font-medium'>Name</label>
                        <div className = 'w-[90%] flex items-center p-3 bg-[#1a1a1a]'>
                            <input 
                                type='text'
                                name ='name'
                                value={formData.name}
                ...
                <div className ='flex mt-2 items-center justify-between'>
                    <label htmlFor='' className ='w-[10%] block text-[#0ea5e9] mb-2 text-xs font-medium mt-5'>Phone</label>
                        <div className = 'w-[90%] flex items-center  p-3 bg-[#1a1a1a]'>
                            <input 
                                type='number'
                                name ='phone'
                ...
                <div className ='flex mt-2 items-center justify-between'>
                    <label htmlFor='' className ='w-[10%] block text-[#0ea5e9] mb-2 text-xs font-medium mt-5'>Email</label>
                        <div className = 'w-[90%] flex items-cente p-3 bg-[#1a1a1a]'>
                            <input 
                                type='email'
                                name ='email'
                ...
                <div>
                    <label className ='block text-white mb-2 mt-6 text-sm font-medium'>Choose your role</label>
                <div className ='flex items-center gap-3 mt-4'>
                    {['Waiter', 'Cashier', 'Admin'].map((role) => {
                        ...
                        return (
                            ...
                            className = {`bg-[#1f1f1f] px-3 py-3 px-4 w-full cursor-pointer  rounded-sm text-[#f6b100]
