        ...
        <div className='fixed inset-0 bg-opacity-50 flex justify-center items-center' style={{ backgroundColor:  'rgba(0, 0, 0, 0.4)'}}>
            <div className='bg-white h-[calc(100vh-5rem)] p-4 rounded-lg  w-[400px]'>
                ...
                <div ref={invoiceRef} className='p-4'>
                    ...
                    <h2 className='text-xl font-bold text-center mb-2 text-[#1a1a1a]'>Payment Receipt</h2>
                    <p className={`text-center text-[#0ea5e9]`}>Thank you for your payment</p>
                ...
                <div className='flex justify-between mt-4'>
                    ...
                    <button
                        onClick={() => setPaymentInvoice(false)}
