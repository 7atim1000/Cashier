    ...
    return(
        <div className='fixed inset-0 bg-opacity-50 flex items-center justify-center  z-50' style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)' }}>
            <motion.div
                ...
                className='bg-[#1f1f1f] p-2 rounded-lg shadow-lg/30 w-120 md:mt-1 mt-1 h-[calc(100vh-5rem)] overflow-y-scroll scrollbar-hidden border-b-3 border-[#0ea5e9]'
            >


                {/*Modal Header */}
                <div className ='flex justify-between items-center  bg-[#383838] p-2 rounded-md'>
                <h2 className ='text-[#f5f5f5] text-sm font-semibold'>New Customer</h2>
                ...
                <form className='mt-3 space-y-6' onSubmit={handleSubmit}>
                    ...
                    <div className='mt-12 flex items-center justify-between'>
                        <label className='w-[25%] text-[#0ea5e9] block mb-2 mt-3 text-xs font-medium'>Customer Name :</label>
                        <div className='w-[75%] flex items-center  p-3 bg-[#1f1f1f] shadow-xl'>
                            <input
                                type='text'
                                name='customerName'
                    ...
                    <div className ='flex items-center justify-between'>
                        <label className='w-[25%] text-[#0ea5e9] block mb-2 mt-3 text-xs font-medium'>Contact number : </label>
                    ...
                    <div className ='flex items-center justify-between'>
                        <label className='w-[25%] text-[#0ea5e9] block mb-2 mt-3 text-xs font-medium'>Address : </label>
                        <div className='flex w-[75%] items-center p-3 bg-[#1f1f1f] shadow-xl'>
                            <input
                                type='text'
                                name='address'
                    ...
                    <div className ='flex items-center justify-between'>
                        <label className='w-[25%] text-[#0ea5e9] block mb-2 mt-3 text-xs font-medium'>Opening Balance : </label>
                        <div className='flex w-[75%] items-center p-3 bg-[#1f1f1f] shadow-xl'>
                            <input
                                type='text'
                                name='balance'
