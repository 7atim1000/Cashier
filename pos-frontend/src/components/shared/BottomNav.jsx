    ...
    return (
        <div className='fixed bottom-0 left-0 right-0 bg-linear-65 from-[#1a1a1a] to-[#e6e6e6] p-2 h-15 flex justify-around'>
            ...
            <button 
                ...
                className='text-[#f5f5f5]  w-[200px] rounded-[20px] flex items-center justify-center cursor-pointer'>
                <CiCircleMore className='inline mr-2' size={30} />More</button>
            ...
            {isMoreModal && (
                ...
                >
                    <div className='flex flex-col bg-sky- rounded-lg p-3 min-w-[300px]'>
                        ...
                        <hr className='border-t-2 border-[#0ea5e9] mb-2' />
                        <div className='flex flex-col gap-5 justify-between items-center px-8 mt-1'>
                            ...
                            <div className='flex justify-between  items-center shadow-xl '>
                                <button onClick={() => { setIsMoreModal(false); navigate('/customers'); }}
                                    className='flex justify-around items-center  w-70 h-12 shadow-xl bg-[#383838] rounded-sm px-2 py-3 text-sm text-[#0ea5e9] font-semibold cursor-pointer'>
                                    Customers
                            ...
                            <div className='flex justify-between  items-center shadow-xl '>
                                <button onClick={() => { setIsMoreModal(false); navigate('/services'); }}
                                    className='flex justify-around items-center  w-70 h-12 shadow-xl bg-[#383838] rounded-sm px-2 py-3 text-sm text-[#0ea5e9] font-semibold cursor-pointer'>
                                    Items
                                    <MdRestaurantMenu className='inline text-[#0ea5e9] w-10 h-6 ' />
                                </button>
                            </div>
                            <div className='flex justify-between  items-center shadow-xl '>
                                <button onClick={() => { setIsMoreModal(false); navigate('/units'); }}
                                    className='flex justify-around items-center  w-70 h-12 shadow-xl bg-[#383838] rounded-sm px-2 py-3 text-sm text-[#0ea5e9] font-semibold cursor-pointer'>
                                    Units
                                    <MdOutlineCategory className='inline text-[#0ea5e9] w-10 h-6 ' />
                                </button>
                            </div>
                            <div className='flex justify-between  items-center shadow-xl '>
                                <button onClick={() => { setIsMoreModal(false); navigate('/invoices'); }}
                                    className='flex justify-around items-center  w-70 h-12 shadow-xl bg-[#383838] rounded-sm px-2 py-3 text-sm text-[#0ea5e9] font-semibold cursor-pointer'>
                                    Orders Management
                                    <VscListOrdered className='inline text-[#0ea5e9] w-10 h-6 ' />
                                </button>
                            </div>
