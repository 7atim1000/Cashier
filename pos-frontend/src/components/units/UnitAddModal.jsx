    ...
    return(
        ...
        <div className='fixed inset-0 bg-opacity-50 flex items-center justify-center shadow-lg/10 z-50 ' style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)' }}>
            <motion.div
                ...
                className='bg-[#1f1f1f] p-2 rounded-lg shadow-lg/30 w-120 md:mt-1 mt-1 h-[calc(100vh-5rem)] border-b-3 border-[#0ea5e9]'
            >


                {/*Modal Header */}
                <div className ='flex justify-between items-center  bg-[#383838] p-2 rounded-md'>
                <h2 className ='text-[#f5f5f5] text-sm font-semibold'>New Unit</h2>
                ...
                <form className='mt-3 space-y-6' onSubmit={handleSubmit}>
                    <div className='mt-5'>
                        ...
                        <label className='text-[#0ea5e9] block mb-2 mt-3 px-4 text-sm font-medium'>Unit Name :</label>
                        <div className='mt-5 flex items-center justify-between gap-5'>
                            <div className='w-full flex items-center p-3 px-4 bg-[#1f1f1f] shadow-lg/30'>
                                <input
                                    type='text'
                                    name='unitName'
                                    ...
                                    className='bg-transparent text-[#1a1a1a] focus:outline-none text-white border-b border-[#0ea5e9] w-full'
                                    required
                                    autoComplete='none'
                                />
                            </div>
