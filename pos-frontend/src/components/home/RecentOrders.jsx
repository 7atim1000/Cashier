...
// fetch 
    ...
    return (
        ...
        <div className='px-8 mt-6'>
            ...
            <div className='bg-[#1a1a1a] w-full h-[calc(100vh-5rem-15rem)] rounded-lg shadow-lg/30 border-t border-sky-400'>
                ...
                <div className='flex items-center gap-4 bg-[#383838] rounded-[20px] px-6 py-2 mx-6'>
