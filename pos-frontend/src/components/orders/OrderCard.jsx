...
const OrderCard = ({key, order}) => {
    ...
    return (
            ...
            <div className='w-[400px] bg-[#1f1f1f] p-4 rounded-lg mb-4 shadow-lg/30 border-b border-[#f6b100]'>
                ...
                <button className='bg-[#f6b100] p-1 w-10 h-10 text-sm font-bold rounded-full'>{getAvatarName(order.customerDetails.name)}</button>
                ...
                <hr className ='w-full mt-4 text-[#383838] border-t-2'/>
